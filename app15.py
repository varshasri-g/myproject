        ...
        if st.button("Submit"):
            try:
                ...
                if summary_df.shape[0] > 0:
                    ...
                    file_path = f"C:/Users/Guest_User/Desktop/Database/project system/{file_name}"  
                    ...
                    word_file_path = f"C:/Users/Guest_User/Desktop/Database/project system/scopes/{word_file_name}"
                    doc = Document()
